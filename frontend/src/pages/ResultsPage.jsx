...
const ResultsPage = () => {
    ...
    return (
        <div className="main-card bg-white dark:bg-card-bg w-full max-w-2xl mx-auto rounded-xl p-8 md:p-12 text-center fade-in">
            <h1 className="text-4xl font-bold text-gray-800 dark:text-white mb-4">Quiz completed!</h1>
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">Here are your results.</p>
            ...
            {timeTaken !== null && (
                <div className="mb-8">
                    <p className="text-lg text-gray-500 dark:text-gray-400">Completion time</p>
            ...
            <div className="flex justify-around mb-10">
                <div>
                    <p className="text-lg text-gray-500 dark:text-gray-400">Score</p>
                    <p className="text-2xl font-bold text-gray-800 dark:text-white">{score} / {totalMaxPoints}</p>
                </div>
                <div>
                    <p className="text-lg text-gray-500 dark:text-gray-400">Earned</p>
                    <p className="text-2xl font-bold text-green-600 dark:text-green-400">{score}</p>
                </div>
                <div>
                    <p className="text-lg text-gray-500 dark:text-gray-400">Lost</p>
